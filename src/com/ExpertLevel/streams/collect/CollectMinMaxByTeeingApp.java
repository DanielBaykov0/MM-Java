...
public class CollectMinMaxByTeeingApp {
    ...
    public static void main(String[] args) {
        ...
        WeatherByMonth maxDayTimeTemperature = weatherAverages.stream()
                .collect(Collectors.maxBy(Comparator.comparing(WeatherByMonth::getDayTimeTemperature))).get();
        ...
        WeatherByMonth minNightTimeTemperature = weatherAverages.stream()
                .collect(Collectors.minBy(Comparator.comparing(WeatherByMonth::getNightTimeTemperature))).get();
