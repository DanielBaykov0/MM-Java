...
public class AuthorRepository {
    ...
    public static List<Author> getAuthors() {
        ...
        list.add(new Author("Jan", "Wiley", "Italy", LocalDate.of(1962, 6, 1), true, null));
        ...
        list.add(new Author("George", "Elsevier", "Russia", LocalDate.of(1979, 10, 19), true, LocalDate.of(2022, 12, 24)));
