...
public class PaperBookRepository {
        ...
        public static Map<Integer, PaperBook> getPaperBooks() {
            ...
            list.put(1, new PaperBook(BookType.PAPER, "Star Wars", "Luke Shaw", "Fantasy",  "Fighting in the galaxy", 1, 2, 1, null));
            list.put(2, new PaperBook(BookType.PAPER, "Star Wars", "Luke Shaw", "Fantasy",  "Fighting in the galaxy", 1, 2, 1, null));
            list.put(3, new PaperBook(BookType.PAPER, "Avatar", "James Cameron", "Fantasy", "Imaginary world", 2, 4, 1, null));
            list.put(4, new PaperBook(BookType.PAPER, "Avatar", "James Cameron", "Fantasy", "Imaginary world", 2, 4, 1, null));
            list.put(5, new PaperBook(BookType.PAPER, "Avatar", "James Cameron", "Fantasy", "Imaginary world", 2, 4, 1, null));
            list.put(6, new PaperBook(BookType.PAPER, "Avatar", "James Cameron", "Fantasy", "Imaginary world", 2, 4, 1, null));
            list.put(7, new PaperBook(BookType.PAPER, "Lord of the rings", "J. R. R. Tolkien", "Fantasy", "Journey to destroy a ring", 3, 3, 1, null));
            list.put(8, new PaperBook(BookType.PAPER, "Lord of the rings", "J. R. R. Tolkien", "Fantasy", "Journey to destroy a ring", 3, 3, 1, null));
            list.put(9, new PaperBook(BookType.PAPER, "Lord of the rings", "J. R. R. Tolkien", "Fantasy", "Journey to destroy a ring", 3, 3, 1, null));
            list.put(10, new PaperBook(BookType.PAPER, "What a life", "Tom Leveen", "Autobiography", "Life ot Tom", 4, 2, 1, null));
            list.put(11, new PaperBook(BookType.PAPER, "What a life", "Tom Leveen", "Autobiography", "Life ot Tom", 4, 2, 1, null));
