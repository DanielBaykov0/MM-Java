package com.ExpertLevel.streams.skiplimit;
...
public class SkipLimitApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Top 3 least expensive fruit boxes: " + top3LeastExpensiveFruitBoxes);
        ...
        List<Item> top3MostExpensiveFruitBoxes = fruitBoxes.stream()
                ...
                .limit(3)
                .collect(Collectors.toList());
        System.out.println("Top 3 most expensive fruit boxes: " + top3MostExpensiveFruitBoxes);
    }
}
