package com.ExpertLevel.streams.distinct;
...
public class DistinctApp {
    ...
    public static void main(String[] args) {
        ...
        List<String> availableFruits = fruits.stream().distinct().sorted().collect(Collectors.toList());
        ...
        List<Product> availableProducts = cereals.stream().distinct().collect(Collectors.toList());
