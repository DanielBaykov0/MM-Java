package com.AdvancedLevel.arrayfunctions;
...
public class ArrayFunctionsApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The 10th player gained50 points");
        gamerPoints[9] += 50;
        System.out.println(Arrays.toString(gamerPoints));
        ...
        int[] topFivePoints = Arrays.copyOf(gamerPoints, 5);
        System.out.println(Arrays.toString(topFivePoints));

        System.out.println("The last 5 points");
        int[] lastFivePoints = Arrays.copyOfRange(gamerPoints, gamerPoints.length - 5, gamerPoints.length);
