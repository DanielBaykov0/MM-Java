...
public class FileClassUsefulFunctionsApp {
    ...
    public static void main(String[] args) {
        ...
        File fileHandlingApp = new File("src/com\\AdvancedLevel\\filehandling\\FileHandlingApp.java");
        ...
        System.out.println("The pathname is absolute: " + fileHandlingApp.isAbsolute());
